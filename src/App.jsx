  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/tantangan" element={<PlaceholderPage judul="🚣 Tantangan" pesan="Fitur Pacu Jalur Kuantan Singingi segera hadir!" />} />
...
function PlaceholderPage({ judul, pesan }) {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4"
      ...
      <h1 className="text-3xl font-black mb-2" style={{ color: '#C0392B' }}>
        {judul}
      </h1>
